    ...
    var e = {
        28: (e,n,t)=>{
            ...
            var r = t(81)
              ...
              , a = t(645)
              , o = t.n(a)()(l());
            o.push([e.id, "@import url(https://fonts.googleapis.com/css2?family=Hubballi&family=Ledger&display=swap);"]),
            o.push([e.id, "*{ \n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  height: 100vh;\n  padding: 24px 16px;\n  background-color: #0a25cf;\n  font-family: 'Hubballi';\n  display: flex;\n  justify-content: center;\n\n}\nli{\n  margin: 8px;\n  color: #FFA384;\n}\n.prev-next{\n  gap: 10px;\n  display: flex;\n  align-items: center;\n}\n.prev-next > button {\n  width: 100px;\n  height: 30px;\n  color: #FFA384;\n  font-weight: 700;\n  border: 1px solid hotpink;\n  border-radius: 10px;\n  cursor: pointer;\n}\nbutton:hover {\n  transition: 100ms;\n  transform: scale(1.1);\n}", ""]);
            const u = o
        }
        ,
        645: e=>{
    ...
    (()=>{
        ...
        function u(n) {
            ...
            e.useEffect)((function() {
                ...
                fetch("https://dummyjson.com/products/search?q=".concat(t, "&limit=10&skip=").concat(i)).then((function(e) {
                    return e.json()
                }
                )).then((function(e) {
                    o(e)
            ...
            e.createElement("div", {
            ...
            }, e.createElement("ul", null, l.products.map((function(n) {
                ...
                onClick: function() {
                    return s(Math.max(0, i - 10))
                }
            }, "prev"), e.createElement("label", null, i / 10 + 1), e.createElement("button", {
                onClick: function() {
                    return s(Math.min(90, i + 10))
                }
            }, "next")))
        }
        function i(e, n) {
